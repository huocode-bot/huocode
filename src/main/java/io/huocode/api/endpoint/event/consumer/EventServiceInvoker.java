package io.huocode.api.endpoint.event.consumer;

import io.huocode.api.PojaGenerated;
import io.huocode.api.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("io.huocode.api.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "io.huocode.api.service.event."
